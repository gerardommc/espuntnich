#' @title Learn how to set up priors for a Mahalanobis distance point process model with global climate covariance matrix
#' @description
...
#' @examples
#' priors <- mahalGlobalPriors(cent.mean = rep(0, 4),
#'                             cent.prec = rep(0.1, 4),
#'                             mu.b.mean = rep(0, 4),
...
mahalGlobalPriors <- function(cent.mean = NULL,
                              cent.prec = NULL,
                              mu.b.mean = NULL,
                              mu.b.prec = NULL,
                              R = NULL,
