#' @title Learn how to set up priors for a Mahalanobis distance point process model with local presence climate covariance matrix
#' @description
...
#' @examples
#' \dontrun{
#' priors <- mahalLocalPriors(cent.mean = rep(0, 4),
#'                             cent.prec = rep(0.1, 4),
#'                             mu.b.mean = rep(0, 4),
...
mahalLocalPriors <- function(cent.mean = NULL,
                              cent.prec = NULL,
                              mu.b.mean = NULL,
                              mu.b.prec = NULL,
                              R = NULL,
