#' @title Print summary statistics for an asymmetric ppmve euclidean distance model.
#' @description
...
#' @param model A model object of class ppmveAsym with euclidean distance
...
#' }
#' @export
#' @method summary.ppmveAsym euclidean

summary.ppmveAsym.euclidean <- function(model){
